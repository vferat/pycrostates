...
- Add optional correlation-threshold rejection to cluster prediction and apply smoothing independently between unlabeled samples. (:pr:`290` by `Victor Férat`_).
